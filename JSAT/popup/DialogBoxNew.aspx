<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DialogBoxNew.aspx.cs" Inherits="JSAT.DialogBoxNew" %>
...
<script type = "text/javascript">
    function CloseWindow() {
        ...
        var id = '<%= txtEmployeeCode.ClientID %>';
        //close the dialog window
        if (window.opener) {
            window.opener.returnValue = document.getElementById(EID).value + "$" + document.getElementById(Name).value + "$" + document.getElementById(id).value;
        }
        window.returnValue = document.getElementById(EID).value + "$" + document.getElementById(Name).value + "$" + document.getElementById(id).value;
        window.close();
    }
</script>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <asp:TextBox ID="txtEmployeeCode" runat="server" Enabled="False" Height="0px" 
        ...
        <asp:Button ID="Button1" runat="server" Text="OK" Width="96px" 
            OnClientClick="CloseWindow()" Height="37px" onclick="Button1_Click" />
