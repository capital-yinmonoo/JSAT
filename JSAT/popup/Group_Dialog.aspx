<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Group_Dialog.aspx.cs" Inherits="JSAT.Group_Dialog" %>
...
<body>
    ...
    <asp:GridView ID="gvGroup" runat="server" AllowPaging="True" Font-Size="Medium"
            ...
            <Columns>
                <asp:TemplateField>
                    <ItemTemplate>
                        <asp:RadioButton ID="rdoSearch" runat="server" AutoPostBack="true" onclick= "RadioCheck(this)" 
                             oncheckedchanged="rdoSearch_CheckedChanged"/>
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
