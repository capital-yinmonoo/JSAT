...
namespace JSAT
{
    public partial class Group_Dialog : System.Web.UI.Page
    {
        popup_BL popup;
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                popup = new popup_BL();
                DataTable dt = popup.SearchByGroup();
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            {
                code = Convert.ToInt32(txtSearchGroupID.Text.Trim());
            }
            DataTable dt=popup.PopupSearchGroupName(txtSearchGroupName.Text.Trim(), code);
            gvGroup.DataSource = dt;
            gvGroup.DataBind();
        }
