<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Country.aspx.cs" Inherits="JSAT_Ver1.Country" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <style type="text/css">
        #MainContent_gvCountry tbody tr th {
            text-align: center;           
        }        
    </style>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <label>国 入力 (Enter Country): </label>
                            ...
                            <asp:GridView ID="gvCountry" runat="server" CellPadding="10" ForeColor="#333333"  DataKeyNames="ID" ShowFooter="True"
                             GridLines="None" AutoGenerateColumns="False" AllowPaging="True" class="table"
                             onrowdeleting="gvCountry_RowDeleting" onrowediting="gvCountry_RowEditing" onrowupdating="gvCountry_RowUpdating" 
                             onrowcancelingedit="gvCountry_RowCancelingEdit" Height="213px" Width="900px" OnRowDataBound="gvCountry_RowDataBound" onpageindexchanging="onPaging" PageSize="20" float="left" >
                             <PagerSettings Mode="NumericFirstLast" NextPageText="Next" FirstPageText="First" LastPageText="Last" PreviousPageText="Previous" />
                                <Columns>
                                 ...
                                 <asp:TemplateField HeaderText="国 (Countries)" HeaderStyle-ForeColor="White">
                                     <ItemTemplate>                 
                                   ...
                                   <FooterTemplate >
                                         <asp:Label ID ="lblName" runat="server" Text="新しい国 入力 (Enter New Country): " />
                                         <br/>
                                   ...
                                   <ItemTemplate>
                                        ...
                                        <asp:LinkButton ID="lnkDelete" runat="server" Text="Delete" CommandName="Delete" CssClass="btn btn-danger btn-outline btn-sm"> </asp:LinkButton>
                                   </ItemTemplate>
                                </asp:TemplateField> 
