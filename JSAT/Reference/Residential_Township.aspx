<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="Residential_Township.aspx.cs" Inherits="JSAT.Reference.Residential_Township" %>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="form-group" style="display: normal;">
                                ...
                                <asp:TextBox ID="TxtsearchRTS" runat="server" CssClass="form-control" Height="30px" Width="484px" placeholder="Enter Search Data"></asp:TextBox>
                            ...
                            <asp:GridView ID="GVResidentialTownship" runat="server" AutoGenerateColumns="false" ShowFooter="true" CellPadding="10" class="table"
                                ForeColor="#333333" DataKeyNames="ID" GridLines="None" AllowPaging="True" Height="213px" Width="900px" OnRowDeleting="GVTownship_RowDeleting"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Township" HeaderStyle-ForeColor="White">
                                        <ItemTemplate>
                                            <asp:Label ID="LblTownship" runat="server" Text='<%#Eval("Description") %>'></asp:Label>
                                        </ItemTemplate>
                                        <EditItemTemplate>
                                            <asp:TextBox ID="TxtTownship" runat="server" CssClass="form-control" Text='<%#Eval("Description") %>' Width="500px" MaxLength="200"></asp:TextBox>
                                        </EditItemTemplate>
                                        <FooterTemplate>
