<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Industry_Type.aspx.cs" Inherits="JSAT_Ver1.Industry_Type" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <style type="text/css">
        #MainContent_gvIndustry_Type tbody tr th
        {
            text-align: center;
        }
    </style>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            業種(大分類)(Large _Industry _Type)
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <div class="form-group" style="display: normal;">
                                <label>Enter Search IndustryType : </label>
                            ...
                            <asp:GridView ID="gvIndustry_Type" runat="server" CellPadding="10" ForeColor="#333333" DataKeyNames="ID" ShowFooter="True"
                                GridLines="None" AutoGenerateColumns="False" AllowPaging="True" Height="213px" Width="900px" class="table"
                                OnRowUpdating="gvIndustryType_RowUpdating" OnRowEditing="gvIndustryType_RowEditing" OnRowCancelingEdit="gvIndustryType_RowCancelingEdit"
                                OnRowDataBound="gvIndustryType_RowDataBound" OnRowDeleting="gvIndustryType_RowDeleting" PageSize="20" float="left">
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="業種(大分類)(Industry_Type)" FooterStyle-Width="900px" HeaderStyle-ForeColor="White">
                                        <ItemTemplate>
                                        ...
                                        <FooterTemplate>
                                            <asp:Label ID="lblName" runat="server" Text="新業種　入力(Enter New Industry Type): " />
                                            <br />
