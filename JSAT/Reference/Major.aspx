<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Major.aspx.cs" Inherits="JSAT_Ver1.Major" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
     <style type="text/css">
        #MainContent_gvMajor tbody tr th {
            text-align: center;           
        }        
    </style>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <asp:GridView ID="gvMajor" runat="server" CellPadding="10" ForeColor="#333333"  DataKeyNames="ID" ShowFooter="True" 
                            GridLines="None" AutoGenerateColumns="False" AllowPaging="True" Height="213px" Width="900px" onrowupdating="gvMajor_RowUpdating" 
                            onrowdatabound="gvMajor_RowDataBound"  onrowdeleting="gvMajor_RowDeleting" onrowediting="gvMajor_RowEditing" class="table"
                            onrowcancelingedit="gvMajor_RowCancelingEdit" onpageindexchanging="onPaging" PageSize="20" float="left">
                            <PagerSettings Mode="NumericFirstLast" NextPageText="Next" FirstPageText="First" LastPageText="Last" PreviousPageText="Previous" />
                                ...
                                <asp:TemplateField HeaderText="Major" FooterStyle-Width="900px" HeaderStyle-ForeColor="White">
                                    <ItemTemplate>
                                ...
                                <FooterTemplate >
                                    <asp:Label ID ="lblName" runat="server" Text="Enter New Major: "/><br/>
