<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Position.aspx.cs" Inherits="JSAT_Ver1.Position" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
     <style type="text/css">
        #MainContent_gvPosition tbody tr th {
            text-align: center;           
        }        
    </style>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <label>Enter Search Position:</label>
                            ...
                            <asp:DropDownList runat="server" ID="ddlDepartment" CssClass="form-control" Height="30px" Width="400px" OnSelectedIndexChanged="ddlDepartment_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>
                            </div>
                            <asp:GridView ID="gvPosition" runat="server" CellPadding="10" ForeColor="#333333" DataKeyNames="ID" ShowFooter="True"
                            GridLines="None" AutoGenerateColumns="False" AllowPaging="True" OnRowCommand="gv_RowCommand" OnRowDataBound="gvPosition_RowDataBound"
                            Height="213px" Width="900px" OnRowDeleting="gvPosition_RowDeleting" OnRowEditing="gvPosition_RowEditing" class="table"
                            OnPageIndexChanging="onPaging" PageSize="20" float="left">
                                ...
                                <Columns>
                                     ...
                                     <asp:TemplateField HeaderText="Positions" FooterStyle-Width="900px" HeaderStyle-ForeColor="White">
                                         <ItemTemplate>
